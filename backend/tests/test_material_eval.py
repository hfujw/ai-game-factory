"""测试 _evaluate_material — 素材相关性评估。"""
import pytest
from app.agents.orchestrator import _evaluate_material


def test_no_material_returns_none():
    result = _evaluate_material([], "秦始皇")
